...
The next development step is to create a GUI for this script. 
...
title = 'Kivalina_Alaska_1'

fp_zones = r"F:\csb\tide zone polygons\tide_zone_polygons_new_WGS84.shp"
csb = r"F:\csb\raw\Kivalina_AK.csv"
BAG_filepath = "F:/csb/comparison data/H12520_MBVB_4m_MLLW_Combined.bag"
...
def draft_corr():    
    ...
    #df = pd.read_csv(r"E:\CSB_13SEPT2021\VESSEL_OFFSETS_csb_corr_Toksook_Bay_Alaska_1.csv")
...
def rasterize_CSB():    
    ...
    geo_grid["depth_final"].rio.to_raster('F:/csb/results/csb_OFFSETS_APPLIED_'+ title + "_1.tif")
