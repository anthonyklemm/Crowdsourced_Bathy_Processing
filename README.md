...
9. Export CSB points to shapefile for further bathy processing in ArcGIS Pro (IDW gridding, etc...)
10. Export out a geotiff (not using any interpolation) at user-specified EPSG CRS and resolution ***WANT TO STILL CHANGE IT TO IDW***
